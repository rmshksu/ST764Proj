...
install.packages("readxl", dependencies=T, lib = "_bookdown_files/", repos = "https://mirror.las.iastate.edu/CRAN/")
install.packages("lubridate", dependencies=T, lib = "_bookdown_files/", repos = "https://mirror.las.iastate.edu/CRAN/")
install.packages("dplyr", dependencies=T, lib = "_bookdown_files/", repos = "https://mirror.las.iastate.edu/CRAN/")
install.packages("tidyr", dependencies=T, lib = "_bookdown_files/", repos = "https://mirror.las.iastate.edu/CRAN/")
install.packages("stringr", dependencies=T, lib = "_bookdown_files/", repos = "https://mirror.las.iastate.edu/CRAN/")
install.packages("ggplot2", dependencies=T, lib = "_bookdown_files/", repos = "https://mirror.las.iastate.edu/CRAN/")
install.packages("withr", dependencies=T, lib = "_bookdown_files/", repos = "https://mirror.las.iastate.edu/CRAN/")
install.packages("labeling", dependencies=T, lib="_bookdown_files/", repos = "https://mirror.las.iastate.edu/CRAN/")
install.packages("farver", dependencies=T, lib="_bookdown_files/", repos = "https://mirror.las.iastate.edu/CRAN/")
```
